...
var IonicDeployImpl = /** @class */ (function () {
    ...
    IonicDeployImpl.prototype.reloadApp = function () {
        return __awaiter(this, void 0, void 0, function () {
            var prefs, shouldReload, newLocation;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        prefs = this._savedPreferences;
    ...
    IonicDeployImpl.prototype.sync = function (syncOptions, progress) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.downloadUpdate(wrappedProgress)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3:
...
var IonicDeploy = /** @class */ (function () {
    ...
    IonicDeploy.prototype.sync = function (syncOptions, progress) {
        if (syncOptions === void 0) { syncOptions = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!this.disabled) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.delegate];
                    case 1: return [2 /*return*/, (_a.sent()).sync(syncOptions, progress)];
                    case 2: return [2 /*return*/];
                }
            });
        });
