import { CallbackFunction, CheckForUpdateResponse, HookFunction, ICurrentConfig, IDeployConfig, ISnapshotInfo, ISyncOptions } from './IonicCordova';
export declare class DeployClass implements IDeployPluginAPI {
    ...
    addPreInstallVersionHook(hook: HookFunction): Promise<void>;
}
